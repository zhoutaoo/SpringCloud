...
VALUES (101, '新增用户', 'user_manager:btn_add', 'button', '/user', 'POST', '新增用户功能', now(), now(), 'system', 'system'),
  (102, '编辑用户', 'user_manager:btn_edit', 'button', '/user', 'PUT', '编辑用户功能', now(), now(), 'system', 'system'),
  ...
  (202, '编辑角色', 'role_manager:btn_edit', 'url', '/role', 'PUT', '编辑角色功能', now(), now(), 'system', 'system'),
  ...
  (205, '根据用户id查询角色', 'role_manager:user', 'url', '/role/user/{id}', 'GET', '根据用户id获取用户所拥有的角色集', now(), now(), 'system', 'system'),
  (206, '搜索角色', 'role_manager:query', 'url', '/role/conditions', 'POST', '根据条件查询角色', now(), now(), 'system', 'system');
-- 用户关系授权
...
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
  ...
  (207, 103, 201, now(), now(), 'system', 'system'),
  (208, 103, 202, now(), now(), 'system', 'system'),
  (209, 103, 203, now(), now(), 'system', 'system'),
  (210, 103, 204, now(), now(), 'system', 'system'),
  (211, 103, 205, now(), now(), 'system', 'system'),
  (212, 103, 206, now(), now(), 'system', 'system');