...
redis.call('set','gateway_routes::103','{"uri": "lb://organization:8010", "id": "organization", "predicates": [{ "name": "Path", "args": { "pattern": "/organization/**" } }], "filters":[{ "name": "StripPrefix", "args": { "parts": "1" } }] }');
